...
```bash
$ cd /path/to/kotlin-springboot-boilerplate
...
#### ソースのダウンロード
```bash
$ git clone https://github.com/isystk/kotlin-springboot-boilerplate.git
$ git submodule init
...
1. Fork it ( http://github.com/isystk/kotlin-springboot-boilerplate/fork )
